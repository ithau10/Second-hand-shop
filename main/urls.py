...
urlpatterns=[
    ...
    path('cool_stuff',views.coolstuff, name='cool-stuff'),
    path('random_feature',views.randomfeature, name='random_feature'),
    path('team_feature',views.teamfeature, name='team_feature'),
    path('location',views.location, name='location'),
    path('privacy',views.privacy, name='privacy'),
    path('terms',views.terms, name='terms'),
    path('developer_stuff',views.developerstuff, name='developer_stuff'),
    path('developer_stuff',views.developerstuff, name='developer_stuff'),
    path('gt_shop',views.aboutGT, name='gt_shop'),
